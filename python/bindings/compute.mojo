...
def add_to_module(mut mb: PythonModuleBuilder) raises -> None:
    ...
    mb.def_function[wrap[ExecutionContext, _serial_context]()]("_serial_context")
    mb.def_function[wrap[ExecutionContext, _parallel_context]()]("_parallel_context")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, add]()]("add")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, subtract]()]("subtract")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, multiply]()]("multiply")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, divide]()]("divide")
    mb.def_function[wrap[AnyArray, ExecutionContext, AnyScalar, sum]()]("sum")
    mb.def_function[wrap[AnyArray, ExecutionContext, AnyScalar, product]()]("product")
    ...
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, equal]()]("equal")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, not_equal]()]("not_equal")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, less]()]("less")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, less_equal]()]("less_equal")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, greater]()]("greater")
    mb.def_function[wrap[AnyArray, AnyArray, ExecutionContext, AnyArray, greater_equal]()]("greater_equal")
    mb.def_function[wrap[AnyArray, Bool, Bool, ExecutionContext, AnyArray, sort_indices]()]("sort_indices")
    mb.def_function[wrap[AnyArray, Bool, Bool, ExecutionContext, AnyArray, sort]()]("sort")
