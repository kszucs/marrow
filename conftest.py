...
class MojoRunner:
    ...
    #: path unless backticked.  ``marrow/expr2/comptime/`` is a deliberate
    ...
    def module_path(rootpath, fspath):
        ...
        ``marrow/expr2/comptime/tests/x.mojo`` becomes
        ``marrow.expr2.`comptime`.tests.x``.
        """
...
def test_module_path(tmp):
    ...
    reserved.touch()
    assert (
        MojoRunner.module_path(tmp, reserved) == "marrow.expr2.`comptime`.tests.test_x"
    )
