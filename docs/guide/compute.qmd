...
Aggregates return a scalar that **preserves the input type** — an `int32` array
sums to an `int32` scalar:
...
print("sum of empty:      ", ma.sum_(empty, None))      # 0
print("sum of all-null:   ", ma.sum_(all_null, None))   # 0
print("product of empty:  ", ma.product(empty, None))   # 1
```
...
print("min of empty:", ma.min_(empty_f, None))   # +max float
print("max of empty:", ma.max_(empty_f, None))   # -max float
```
