...
2. `ma.add(a, b, None)` imports each argument into Marrow via `__arrow_c_array__` — a pointer exchange, no copy — and runs the SIMD-vectorised Mojo kernel over the raw Arrow buffer.
