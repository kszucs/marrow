...
from marrow.dyn.expr import Expr, col
...
# The JOIN_* kind/strictness/algorithm-hint constants (JOIN_INNER, JOIN_ALL,
# JOIN_ALGO_AUTO, ...) are defined in marrow.kernels.join (imported above)
# and re-exported from here for existing callers of this module.
